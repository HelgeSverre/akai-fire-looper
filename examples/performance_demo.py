...
def demo_cached_operations(fire):
    ...
    print(f"✨ Optimized method is {uncached_time/optimized_time:.1f}x faster than uncached!")
...
def demo_display_caching(fire):
    ...
    changing_time = benchmark_operation("Rendering changing content", render_changing, 50)
    
    print(f"✨ Display caching provides {changing_time/same_time:.1f}x speedup for static content!")
